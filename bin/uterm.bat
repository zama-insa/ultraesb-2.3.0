...
:nojdk
echo "The UltraESB UTerm requires Java v1.6 or later and Java MUST be available in the PATH"
goto end
...
set CLASSPATH="%JAVA_HOME%\lib\tools.jar";lib\patches;lib\patches\*;uconsole\WEB-INF\classes;uconsole\WEB-INF\lib\*;lib\*;lib\optional\*;lib\samples\*

"%JAVA_HOME%\bin\java" -server -Xms256M -Xmx512M %_XDEBUG% "-Dlog4j.configuration=file:%ULTRA_HOME%\conf\management\log4j_uterm.properties" "-Dultra.terminal.config.location=%ULTRA_HOME%\conf" -cp %CLASSPATH% org.adroitlogic.ultraesb.terminal.UltraTerminal %*
