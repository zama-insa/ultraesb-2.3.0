...
# Application
APP_NAME="UConsole"
APP_LONG_NAME="AdroitLogic - UConsole"

# Wrapper
WRAPPER_CMD="./bin/native/wrapper"
WRAPPER_CONF="./conf/management/wrapper-uconsole.conf"
...
stopit() {
    ...
    then
        ...
        #  actually stop as it depends on settings in wrapper-uconsole.conf.
        #  Loop until it does.
        savepid=$pid
        CNT=0
        TOTCNT=0
