...
/**
 * Test case for invokeService mediation API call which in-turn uses the VM transport
 *
 * @author Ruwan
 * @since 2.3.0
 */
public class InvokeServiceTest extends AbstractUTestCase {
    ...
    @Test
    public void serviceCallOverHTTPViaInvokeServiceExternalResponse() {
    ...
    @Test
    public void serviceCallOverHTTPViaInvokeServiceDirectResponse() {
