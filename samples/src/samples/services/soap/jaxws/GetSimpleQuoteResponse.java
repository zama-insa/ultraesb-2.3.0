...
@XmlRootElement(name = "getSimpleQuoteResponse", namespace = "http://soap.services.samples/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getSimpleQuoteResponse", namespace = "http://soap.services.samples/")
